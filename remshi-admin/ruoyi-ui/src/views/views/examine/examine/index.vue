<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="examineList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="请假开始日期" align="center" prop="examineInfoDateBegin" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.examineInfoDateBegin, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="请假结束日期" align="center" prop="examineInfoDateEnd" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.examineInfoDateEnd, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="申请人工号" align="center" prop="examineInfoId" />
      ...
      <el-table-column label="审批结果 " align="center" prop="examineInforesult">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.examine_inforesult" :value="scope.row.examineInforesult"/>
        </template>
      </el-table-column>
